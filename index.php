...
<html lang="en">
                                    ...
                                    <div class="card-body">
                                        <form id="signin-form">
                                            ...
                                            <div class="d-flex align-items-center justify-content-center mt-4 mb-0">
                                                <input type="submit" form="signin-form" id="btn-submit" class="btn btn-primary" value="Sign In">
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center py-3">
                                        Create an account?<a href="pages/signup.php">Sign Up</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="process/signin/crud.js"></script>
</html>
